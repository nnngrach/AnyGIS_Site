...
Когда навигатор подключится к нашему серверу, то сервер зайдет на сайт с картой, введет туда мой личный логин и пароль, загрузит требуемое изображение, а затем перешлет его обратно к навигатору пользователя. Как видите, все довольно просто. Хотя и требует некоторого дополнительного времени на работу этого промежуточного компонента. Более подробно о технической реализации данного скрипта вы можете прочитать в моей статье на [Habr.com][3].

![](/Web/Img/strava-heatmap.png)
