...
Восстановил скрипт для "скриншотинга". А заодно и немного оптимизировал его: теперь он скачивает не по одному тайлу, а сразу квадрат 4х4. Итого, теперь снова должны заработать: Перевалы Вестра, Геокэшинг, Waze и визуализация запросов OverpassTurbo.
